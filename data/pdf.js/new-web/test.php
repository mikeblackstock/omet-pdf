...
//		var DEFAULT_URL= "/Files/max11_1/WORK/Cui/" + "<?php echo $_GET['url']; ?>" -->
		var ds= new Date().getTime();
		var DEFAULT_URL= "<?php echo $_GET['url']; ?>" + "?" + ds;
		var MODE=  "<?php echo $_GET['mode']; ?>";
		DEFAULT_SCALE="1"; 
		function textedit(param) {
			
			var p=param.split(":");
			var s= p[0] + "\n" + p[1] + "\n" + p[2] + "\n" + p[3] + "\n";
//			alert(s);
alert("TODO: Clicking a note will highlight the source code in the editor");
		}
	</script>
	</head>
